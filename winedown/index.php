...
<!--[if (gt IE 10)|!(IE)]> <html lang="en"> <![endif]-->
  ...
  <body>
    ...
    <!-- NAVBAR
    ================================================== -->
    <div class="navbar-wrapper cbp-af-header" style="position: absolute;!important">
      <div class="container">
      ...
      <div class="container">
        <!--div class="row">
          <div class="col-sm-12 margin-top">
            ...
            <img class="img-responsive img-center" src="/housewarming/img/boring-cubicles.jpg" width="800">
          </div>
        </div-->
                ...
                <div id="success_msg" class="clearfix vertical-align" style="display:none;">Thank you. See you on the 29th!&nbsp;&nbsp;&nbsp;
                  ...
                  <span class="addtocalendar atc-style-blue">
                    <var class="atc_event">
                        ...
                        <var class="atc_organizer_email">office@tenco.se</var>
                    </var>
                </span>
                </div>
              </p>
